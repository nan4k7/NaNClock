...
#define CUSTOMDISPLAY //uncomment this to enable displayMyStuff(). It's an example of how to display values at specified times, like temperature readouts
...
#define LED_PWR_LIMIT 450  // 500mA - Power limit in mA (voltage is set in setup() to 5v)
#define LED_DIGITS 4
...
void loop() {
  ...
  static uint8_t refreshDelay = 75;     // refresh leds every 5ms
...
void paletteSwitcher() {
  ...
  switch (currentIndex) {
    case 0: currentPalette = CRGBPalette16(CRGB::Red); break;
    case 1: currentPalette = CRGBPalette16(CRGB::Green); break;
    case 2: currentPalette = CRGBPalette16(CRGB::Blue); break;
    case 3: currentPalette = CRGBPalette16(CRGB::Yellow); break;
    case 4: currentPalette = CRGBPalette16(CRGB::Cyan); break;
    case 5: currentPalette = CRGBPalette16(CRGB::Magenta); break;
    case 6: currentPalette = CRGBPalette16(CRGB::White); break;
    case 7: currentPalette = CRGBPalette16(CRGB::DarkOrange); break;
    case 8: currentPalette = CRGBPalette16(CRGB::Purple); break;
    case 9: currentPalette = CRGBPalette16(CRGB::HotPink); break;
    case 10: currentPalette = CRGBPalette16(CRGB::Aqua); break;
    case 11: currentPalette = CRGBPalette16(CRGB::Gold); break;
    case 12: currentPalette = CRGBPalette16(CRGB::LawnGreen); break;
    case 13: currentPalette = CRGBPalette16(CRGB::BlueViolet); break;
    case 14:
    ...
    case 16:
      currentPalette = CRGBPalette16(CRGB::Aquamarine,
                                     ...
                                     CRGB::DeepSkyBlue);
      break;
    case 17: currentPalette = RainbowColors_p; break;
    case 18: currentPalette = PartyColors_p; break;
    case 19: currentPalette = CRGBPalette16(CRGB::Gold, CRGB::OrangeRed, CRGB::Tomato, CRGB::FireBrick); break;
    case 20: currentPalette = CRGBPalette16(CRGB::Teal, CRGB::Cyan, CRGB::DodgerBlue, CRGB::Navy); break;
    case 21: currentPalette = CRGBPalette16(CRGB::Green, CRGB::ForestGreen, CRGB::SeaGreen, CRGB::MediumSpringGreen); break;
    case 22: currentPalette = CRGBPalette16(CRGB::Red, CRGB::Crimson, CRGB::DarkRed, CRGB::OrangeRed); break;
    case 23: currentPalette = CRGBPalette16(CRGB::Yellow, CRGB::Gold, CRGB::Orange, CRGB::SaddleBrown); break;
    case 24: currentPalette = CRGBPalette16(CRGB::SkyBlue, CRGB::RoyalBlue, CRGB::BlueViolet, CRGB::DarkSlateBlue); break;
    case 25: currentPalette = CRGBPalette16(CRGB::Purple, CRGB::MediumVioletRed, CRGB::DeepPink, CRGB::HotPink); break;
    case 26: currentPalette = CRGBPalette16(CRGB::White, CRGB::GhostWhite, CRGB::Lavender, CRGB::LightSlateGray); break;
    case 27: currentPalette = CRGBPalette16(CRGB::Orange, CRGB::Coral, CRGB::Salmon, CRGB::LightCoral); break;
    case 28: currentPalette = CRGBPalette16(CRGB::MediumPurple, CRGB::SlateBlue, CRGB::Indigo, CRGB::DarkMagenta); break;
    case 29: currentPalette = CRGBPalette16(CRGB::Chartreuse, CRGB::Lime, CRGB::GreenYellow, CRGB::SpringGreen); break;
    case 30: currentPalette = RainbowStripeColors_p; break;
    case 31: currentPalette = LavaColors_p; break;
  }
...
uint8_t inputButtons() {
  ...
  if (digitalRead(BUTTON_A_PIN) == LOW) currentState += 1;
  if (digitalRead(BUTTON_B_PIN) == LOW) currentState += 2;
